...
html_temp = """
    <div style ="height:50px;width:300px;margin-top: 2px;font-style: italic;">
    <h5 style ="font-family: Lucida Handwriting, Cursive;margin-top: 2px;"> Welcome All !!! </h5>
    </div>
    <div style="background-color:tomato;padding:10px;">
    <h2 style="color:white;text-align:center;font-family: Georgia, serif;">LapTop Price Predictor</h2>
    </div>
    <h6> Enter the laptop details for prediction.</h6>
    """
